...
export default function CalificarPage() {
 ...
 async function guardar() { setGuardando(true); await guardarCalificacion({ entregaId: entrega!.id, equipoId: entrega!.equipoId, documentoClave: "documento1", nombreDocumento: entrega!.nombreArchivo, nombreEquipo: entrega!.nombreEquipo, rubrica, comentarios, recomendadoFinal: recomendado }); await actualizarEntrega(entrega!.id, { estado: "calificado" }); router.push("/maestro/dashboard"); }
